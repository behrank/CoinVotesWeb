...
namespace CoinVotesWeb.Services
{
    public class SignalSubscriptionService : BaseService<SignalSubscription>, ISignalSubscriptionService
    {
        ...
        public override async Task<(List<SignalSubscription> Items, int TotalCount)> GetPagedListAsync(int page, int pageSize, string sortBy = null, bool sortDescending = false)
        {
